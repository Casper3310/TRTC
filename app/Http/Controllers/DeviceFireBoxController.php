...
use App\device_FireBox;
use Illuminate\Http\Request;

class DeviceFireBoxController extends Controller
{
    /**
     ...
     *
     * @param  \App\device_FireBox  $device_FireBox
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request)
    {
        $DeviceData = device_FireBox::where('Circleline_Station_id',$request->stationID)->orderBy('updated_at', 'desc')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(device_FireBox $device_FireBox)
    {
        //
    }
    ...
    public function update($DeviceId,Request $request)
    {
        ...
        $Device = device_FireBox::find($DeviceId);
        $Device->Circleline_Station_id = $request->Circleline_Station_id;
        $Device->name = $request->name;
        $Device->place = $request->place;
    ...
    {
        $item = device_FireBox::find($DeviceId);
        if($item->delete()){
            if($item->image){
