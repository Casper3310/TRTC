...
class DevicePumpController extends Controller
{
    /**
     ...
     *
     * @param  \App\device_pump  $device_pump
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request)
    {
        $DeviceData = device_pump::where('Circleline_Station_id',$request->stationID)->orderBy('updated_at', 'desc')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(device_pump $device_pump)
    {
        //
    }
    ...
    public function update($DeviceId,Request $request)
    {
        ...
        $Device = device_pump::find($DeviceId);
        $Device->Circleline_Station_id = $request->Circleline_Station_id;
        $Device->name = $request->name;
        $Device->place = $request->place;
    ...
    {
        $item = device_pump::find($DeviceId);
        if($item->delete()){
            if($item->image){
