...
use App\device_SmokeDetector;
use Illuminate\Http\Request;

class DeviceSmokeDetectorController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $Device = New device_SmokeDetector();
     ...
     *
     * @param  \App\device_SmokeDetector  $device_SmokeDetector
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request)
    {
        $DeviceData = device_SmokeDetector::where('Circleline_Station_id',$request->stationID)->orderBy('updated_at', 'desc')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(device_SmokeDetector $device_SmokeDetector)
    {
        //
    }
    ...
    public function update($DeviceId,Request $request)
    {
        ...
        $Device = device_SmokeDetector::find($DeviceId);
        $Device->Circleline_Station_id = $request->Circleline_Station_id;
        $Device->name = $request->name;
        $Device->place = $request->place;
    ...
    {
        $item = device_SmokeDetector::find($DeviceId);
        if($item->delete()){
            if($item->image){
