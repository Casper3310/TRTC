...
/* harmony import */ var _serveices_CircleLine_serveice__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../serveices/CircleLine_serveice */ "./resources/js/serveices/CircleLine_serveice.js");
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _serveices_CircleLine_serveice__WEBPACK_IMPORTED_MODULE_1__["LoadStationList"]();
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      _vm._l(_vm.station_list, function(item, index) {
        return _c(
          "router-link",
          {
            key: index,
            staticClass: "btn btn-outline-primary btn-lg",
            attrs: { to: { path: "/" + item.codename } }
          },
...
/***/ "./resources/js/serveices/CircleLine_serveice.js":
/*!*******************************************************!*\
  !*** ./resources/js/serveices/CircleLine_serveice.js ***!
  \*******************************************************/
/*! exports provided: LoadStationList, LoadDeviceList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadStationList", function() { return LoadStationList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadDeviceList", function() { return LoadDeviceList; });
...
function LoadDeviceList($station_id) {
  return Object(_http_serveice__WEBPACK_IMPORTED_MODULE_0__["http"])().get('/Circleline_Station/Device_type', {
    params: {
