        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _context.next = 5;
                return _serveices_Chat_serveice__WEBPACK_IMPORTED_MODULE_1__["SendMessage"](this.room.id, {
                  userId: 1,
  ...
  return _c("div", { staticClass: "chat" }, [
    _c("div", { staticClass: "chat-box" }, [
      ...
      _c(
        ...
        [
          _c("container", {
            attrs: { ChatRoom: _vm.ChatRoom, CurrentRoom: _vm.CurrentRoom },
            on: {
        ...
        [
          _c("ChatBox", {
            attrs: {
              ...
              ShowMessage: _vm.message,
              ChatRoom: _vm.ChatRoom,
              room: _vm.CurrentRoom
            },
            on: { messagesend: _vm.GetMessage }
          })
        ],
        1
      )
...
var render = function() {
  ...
  return _c("div", { staticClass: "chat-box" }, [
    _c("div", { staticClass: "header" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("span", [_vm._v("房間名稱" + _vm._s(_vm.CurrentRoom.id))]),
      _vm._v(" "),
      _vm._m(1)
    ]),
    _vm._v(" "),
    _c(
      ...
      { staticClass: "context" },
      [
        _vm._l(_vm.ShowMessage, function(item, index) {
          return _c("div", { key: index }, [
            item.User_id == 1
              ? _c("div", { staticClass: "outgoing" }, [
                  _c("div", { staticClass: "detail" }, [
                    _c("p", [_vm._v(_vm._s(item.message))])
                  ])
                ])
              : _c("div", { staticClass: "chat incoming" }, [
                  _c("div", { staticClass: "detail" }, [
                    _c("p", [
                      _vm._v(
                        _vm._s(item.user.name) + ":" + _vm._s(item.message)
                      )
                    ])
                  ])
                ])
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._m(0),
      _vm._v(" "),
      _vm._l(_vm.ChatRoom, function(item, index) {
        return _c("div", { key: index, staticClass: "user-list" }, [
          _c(
            "div",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.$emit("roomchange", item)
                }
              }
            },
            [
...
/*!*************************************************!*\
  !*** ./resources/js/serveices/Chat_serveice.js ***!
  \*************************************************/
/*! exports provided: GetUserList, GetChatRoom, GetMessage, SendMessage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function SendMessage(roomId, data) {
  return Object(_http_serveice__WEBPACK_IMPORTED_MODULE_0__["http"])().post("Chat/Room/".concat(roomId, "/message"), data);
}
